<?php
/**
 * Создаёт таблицу предложений «Поиск» мастеров.
 *
 * Запуск:
 *   php migration_scripts/63_create_vigling_user_searches_table.php
 */
...
$table = $mysqli->real_escape_string($prefix . 'vigling_user_searches');
...
echo "Создана/проверена таблица: {$prefix}vigling_user_searches\n";
exit(0);
