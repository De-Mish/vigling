<?php
/**
 * Создаёт таблицу фиксированных слотов предложений «Поиск».
 *
 * Запуск:
 *   php migration_scripts/64_create_vigling_search_slots_table.php
 */
...
$table = $mysqli->real_escape_string($prefix . 'vigling_search_slots');
...
$sql = "CREATE TABLE IF NOT EXISTS `{$table}` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_search_slot` (`search_id`),
...
echo "Создана/проверена таблица: {$prefix}vigling_search_slots\n";
exit(0);
