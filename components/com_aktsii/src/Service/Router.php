...
namespace Viglin\Component\Aktsii\Site\Service;
...
class Router extends RouterBase
{
	...
	public function build(&$query): array
	{
		...
		if ($item && isset($item->query['option']) && $item->query['option'] === 'com_aktsii' && isset($item->query['view']) && $item->query['view'] === 'list') {
	...
	public function parse(&$segments): array
	{
		...
		if (!$item || !isset($item->query['option']) || $item->query['option'] !== 'com_aktsii') {
			return $vars;
		}
