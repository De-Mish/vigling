...
class DisplayController extends BaseController
{
	...
	public function sw()
	{
		...
		echo "  var n = payload.notification || {};\n";
		echo "  if (n.title || n.body) return;\n";
		echo "  var d = payload.data || {};\n";
		echo "  var title = d.title || 'Уведомление';\n";
		echo "  var body = d.body || '';\n";
		echo "  if (!d.url) d.url = '{$root}/';\n";
		echo "  var options = { body: body, data: d, silent: false };\n";
		echo "  if (d.notification_tag) { options.tag = d.notification_tag; options.renotify = true; }\n";
