	...
	<table class="table table-striped orders-table">
		...
		<tbody>
			<?php foreach ($displayRows as $row) :
				...
				<tr class="orders-row orders-row--course-details" id="<?php echo $this->escape($toggleId); ?>">
					<td colspan="5">
			...
			?>
			<tr class="<?php echo $rowClass; ?>" data-time-utc="<?php echo $timeIso ? $this->escape($timeIso) : ''; ?>">
				<td data-label="Клиент / Мастер"><?php echo viglingAppointmentsRenderPeople($item); ?></td>
				<td data-label="Услуга">
